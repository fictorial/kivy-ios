...
try ./configure CC="$I386_CC" LD="$I386_LD" \
	CFLAGS="$I386_CFLAGS" LDFLAGS="$I386_LDFLAGS -Lextralibs/" \
...
lipo -create -output libpython2.7.a libpython2.7-arm.a libpython2.7-i386.a
mv libpython2.7.a $BUILDROOT/python/lib/
